...
public class booleanResults {
    ...
    String temp1 ="";
    String temp2 = "";
    public void start(Stage stage,ObservableList fileName, ObservableList hitRate, String keyWord, String keyWord2, String Sfield, String Sfield2) throws IOException {
                               ...
                               // Body = Body.replace("\n", "").replace("\r", "");
                                ...
                                if(Sfield2 == "body")
                                {
                                    ...
                                    try {
                                     ...
                                     for(int j=0;j<obv1.size();j++)
                                     {
                                        if((obv1.get(j).equals(kw2) || obv3.get(j).equals(kw2)) && flag == true)
                                            {
                                                flag = false;
                                                if(j>4 && ((j+4)<obv1.size()))
                                                {
                                ...
                                else if(Sfield2 == "people")
                                {
                                    ta2.setText(ta2.getText() +  temp2 + "\n\n");
                                }
                                else if(Sfield2 == "places")
                                {
                                    ta2.setText(ta2.getText() + temp2 +  "\n\n");
                                }
                                else if(Sfield2 == "title")
                                {
                                    ta2.setText(ta2.getText() + temp2 + "\n\n");
                                }
        ...
        {
            stem.add(keyWord2.charAt(k));
            
        }
        stem.stem();
        keyWord2= stem.toString();
            ...
            String Body = "";
                ...
                if(Sfield2 == "body")
                {
                    ...
                    while (tokenStream.incrementToken()) {
                     ...
                     for(int j=0;j<obv1.size();j++)
                     {
                        if((obv1.get(j).equals(keyWord2) || obv3.get(j).equals(keyWord2)) && flag == true)
                            {
